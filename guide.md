...
**Card 1 — Business Permit & Expatriate Quota**
Secure the permits your business and foreign employees need to operate legally in Nigeria — from establishment quotas to monthly returns and NIS portal management.
Link: /services/business-permit-expatriate-quota

**Card 2 — e-CERPAC (Residence Permits)**
...
**Business Permit & Expatriate Quota**
Establish your business legally in Nigeria and secure the expatriate positions your organisation needs to operate.
Covers: Business Permit, Establishment Quota, Additional Quota, Renewal, Monthly Returns, Deletions, Immigration Visits, Portal Management.
[Learn More → /services/business-permit-expatriate-quota]
...
## ============================================
## PAGE: BUSINESS PERMIT & EXPATRIATE QUOTA
## (app/services/business-permit-expatriate-quota/page.tsx)
## ============================================

### Hero
- **Headline:** Business Permit & Expatriate Quota Services
- **Sub-headline:** Establish your business legally in Nigeria and secure the expatriate positions your organisation needs to operate — from initial quota approval through to ongoing compliance management.

### Introduction
Every foreign-owned or foreign-affiliated business operating in Nigeria is required to obtain a Business Permit from the Federal Ministry of Interior. Additionally, companies intending to employ expatriate staff must secure Expatriate Quota positions, which authorise the engagement of foreign nationals in specific roles.

Consulat manages the entire process — from initial application through to quota renewals, additions, deletions, monthly returns, and immigration portal management — ensuring your business remains fully compliant at every stage.

### Services List

**Business Permit**
A Business Permit authorises a foreign company to operate and conduct business in Nigeria. It is a prerequisite for obtaining expatriate quota positions and other immigration approvals.
- Preparation and compilation of all required documentation
- Application submission to the Federal Ministry of Interior
- Follow-up and liaison with the Ministry through to approval
- Permit collection and delivery

**Expatriate Quota — Establishment Quota**
The initial quota allocation for newly registered or recently permitted businesses. We guide you through the application process, ensuring the right roles and justifications are presented.

**Expatriate Quota — Additional Quota**
When your business grows and requires more expatriate positions than originally allocated, we handle the application for additional slots, including supporting documentation and Ministry liaison.

**Expatriate Quota — Renewal**
Expatriate Quota positions must be renewed periodically. We track expiry dates, prepare renewal applications, and file them well in advance to prevent any disruption to your workforce.

**Expatriate Quota — Monthly Returns**
Every company holding an Expatriate Quota is required to file Monthly Returns with the Nigeria Immigration Service. Consulat prepares and submits these filings on your behalf, ensuring timely compliance every month.

**Expatriate Quota — Deletions**
When an expatriate leaves the company or a quota position is no longer needed, the slot must be formally deleted from the company's allocation. We handle the deletion process and associated documentation.

**Expatriate Quota — Immigration Visits & Queries**
From time to time, the Nigeria Immigration Service may conduct compliance visits or raise queries regarding your quota utilisation. Consulat provides advisory support, prepares responses, and represents your interests during such engagements.

**Expatriate Quota — Portal Management & Monitoring**
We manage your company's NIS online portal on an ongoing basis — monitoring application statuses, responding to system requests, tracking deadlines, and ensuring nothing falls through the cracks.

### CTA
Need help with your Business Permit or Expatriate Quota? Our team can assess your requirements and guide you through the process from start to finish.
...
| Business Permit | Business Permit & Expatriate Quota Services — Consulat | Business permit applications, expatriate quota management, monthly returns, and NIS compliance services in Nigeria. | business permit Nigeria, expatriate quota Nigeria, monthly returns NIS |
...
## Navbar
- Logo (left)
- Nav links: Home, About, Services (dropdown), Blog, FAQ, Contact
...
- 4 columns:
  ...
  3. Services: Business Permit & Quota, e-CERPAC, e-Visas
